defmodule GibberChat do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(Task.Supervisor, [[name: GibberChat.TaskSupervisor]]),
    ...
    opts = [strategy: :one_for_one, name: GibberChat.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    GibberChat.Endpoint.config_change(changed, removed)
    :ok
  end
end
