defmodule GibberChat.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule GibberChat.MyChannel do
        use GibberChatWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :gibberChat,
                        pubsub_server: GibberChat.PubSub
end
